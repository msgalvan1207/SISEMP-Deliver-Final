sap.ui.define(["sap/ui/core/mvc/Controller",
	...
	return BaseController.extend("com.sap.build.standard.entregaSisemp.controller.CrearArchivo", {
				...
				.then(function(result) {
					if (result === false) {
						...
						return new Promise(function(fnResolve) {
							...
							this.doNavigate("ArchivosDeCampana", oBindingContext, fnResolve, "RelationName");
						}.bind(this));
		...
		onInit: function() {
			...
			this.oRouter.getTarget("CrearArchivo").attachDisplay(jQuery.proxy(this.handleRouteMatched, this));
		...
		onExit: function() {
			...
			var aControls = [{
				"controlId": "Fiori_ObjectPage_ObjectPage_0-sections-Fiori_ObjectPage_Section-1-sectionContent-Fiori_ObjectPage_Form-1-formGroups-Fiori_ObjectPage_FormGroup-1716426122956-formElements-Fiori_ObjectPage_CustomFormElement-1716426325709-control-sap_m_ComboBox-1716426335875",
				"groups": ["items"]
			}];

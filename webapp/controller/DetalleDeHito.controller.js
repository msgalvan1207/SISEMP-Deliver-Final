sap.ui.define(["sap/ui/core/mvc/Controller",
	...
	return BaseController.extend("com.sap.build.standard.entregaSisemp.controller.DetalleDeHito", {
		handleRouteMatched: function(oEvent) {
			var sAppId = "App664245b064ceb247cd4e8da6";

			var oParams = {
				"expand": "Campania,RelationName,RelationName1"
			};
				...
				.then(function(result) {
					if (result === false) {
						...
						return new Promise(function(fnResolve) {
							...
							this.doNavigate("HitosDeCampana", oBindingContext, fnResolve, "Campania");
						}.bind(this));
		...
		onInit: function() {
			...
			this.oRouter.getTarget("DetalleDeHito").attachDisplay(jQuery.proxy(this.handleRouteMatched, this));
